...
def get_image_style_for_category(category: str) -> str:
    """
    画像スタイル: ハイパーリアル写真 + ルパン三世世界観(完全振り切り版)
    全カテゴリ統一: 夜の都会、立ち姿、ローアングル、S字ライン、強い逆光リムライト
    画像はブランド演出として割り切り、PV内容の忠実な視覚化は文章側に任せる
    """
    common_style = (
        ...
        "hair strands, realistic luxurious fabric. Aesthetic: a live-action "
        "Lupin III film, Netflix's 'LUPIN', 'Kingsman', or a James Bond "
        "cinematic frame. The image MUST be indistinguishable from a real "
        "photograph. NOT illustration, NOT anime, NOT painted art, NOT 3D."
    )
    
    composition_directive = (
        "MANDATORY COMPOSITION (these rules are absolute, never compromise):\n"
        "1. CAMERA ANGLE: LOW ANGLE shot from below the subject's waist, "
        "looking up. The viewer should feel they are looking up at her.\n"
        "2. FRAMING: FULL BODY or 3/4 body shot showing her legs and feet. "
        "Subject occupies 40-60% of vertical canvas. NEVER bust-up, NEVER "
        "headshot, NEVER seated at desk, NEVER waist-up only.\n"
        "3. POSE: STANDING with dynamic S-curve body line — one hip "
        "shifted, weight on one leg, slight torso twist, head turned with "
        "intention. Mid-stride, leaning against architecture, or pausing "
        "with attitude. NEVER static, NEVER sitting, NEVER hunched over "
        "any surface, NEVER working at a computer.\n"
        "4. LIGHTING: STRONG RIM LIGHT from behind defining her silhouette "
        ...
        "amber, deep red) from background sources create atmospheric depth.\n"
        "5. SURFACES: Wet-look glossy reflections on the floor or "
        "surrounding surfaces, capturing the colored lights. Atmospheric "
        "haze in the air for cinematic depth."
    )
    ...
    figure_directive = (
        ...
        "femme fatale or international agent vibe. Sharp intelligent eyes "
        "with confident, knowing, slightly playful gaze directed at viewer "
        "or thoughtfully off-camera. Beautiful with distinctive authentic "
        "features — NOT generic AI beauty. Mature sophisticated allure. "
        "HAIR: Long flowing with movement catching the rim light, or "
        "elegantly arranged exposing the neckline. Hair feels real and soft. "
        "WARDROBE: Glamorous yet tasteful — sleek silk or satin evening "
        "dress with sophisticated cut, tailored trench coat over an elegant "
        "outfit, structured cocktail dress, or sharp business suit with "
        "vintage-luxury flair. Glossy fabric sheen. Statement heels visible "
        "(this is mandatory — full body shows footwear). Vintage-luxury "
        "accessories: long earrings, pearls, leather gloves, designer watch. "
        "Allure comes from gaze, posture, lighting, sophistication — NOT "
        "from skin exposure. Clothing remains tasteful (no extreme "
        "necklines, no exposed midriff)."
    )
    ...
    hard_forbidden = (
        ...
        "- Real, identifiable celebrities, actresses, models, public "
        ...
        "- Plunging necklines below sternum, exposed midriff, skirts "
        "  above mid-thigh in a way emphasizing exposure "
        ...
        "- Lab coats (NEVER use lab coats — this is a brand image, not a "
        "  scientific photograph) "
        "- Office desks, PCs, monitors as primary scene elements "
        "- Static stationary poses without dynamic movement"
    )
    
    category_scenes = {
        "regulatory": (
            "Scene direction: She stands in a stately government building "
            "interior at night — vast marble corridor with tall pillars, "
            "deep red carpet, dramatic chandelier lighting overhead. "
            "Polished marble floor reflects the warm light. She is mid-walk "
            "or pausing to look back over her shoulder. The architecture "
            "dwarfs her but her presence dominates. Atmospheric haze."
        ),
        "ai_tech": (
            "Scene direction: She stands in front of a wall of large "
            "monitors displaying abstract data visualizations in an "
            "ultra-modern dark research environment. The monitors backlight "
            "her in cool electric blue and magenta. Glossy floor reflects "
            "the colored lights. She is turned toward the camera mid-action, "
            "perhaps holding a tablet at her side or with one hand raised "
            "toward a holographic display. Strong dramatic rim lighting."
        ),
        "market_business": (
            "Scene direction: She stands on a high-floor terrace or by "
            "floor-to-ceiling windows of a luxurious Tokyo executive lounge "
            "or hotel suite at night. Tokyo skyline behind her with neon "
            "city lights creating bokeh. Strong backlight from the city "
            "lights creates a dramatic rim around her silhouette. Polished "
            "marble or wood floor reflects the warm light. She might hold "
            "a champagne flute, leaning slightly against the window or "
            "walking with elegance toward camera."
        ),
        "china": (
            "Scene direction: She stands in a Shanghai or Hong Kong "
            "atmospheric setting at night — Bund-area luxurious old-money "
            "hotel lobby, retro art deco interior, or high-floor terrace "
            "overlooking Pudong skyline. Warm amber lighting mixed with "
            "neon city glow. Glossy reflective surfaces. Dynamic stride "
            "or pose with confident attitude."
        ),
        "general": (
            "Scene direction: She stands in an upscale atmospheric night "
            "setting — luxurious lounge interior, marble corridor, or "
            "rain-slick city street with neon reflections. Strong rim "
            "lighting, colored accent lights, glossy reflections. Dynamic "
            "S-curve standing pose."
        ),
    }
